...
This repository contains a simple "Message From Database" application built using a three-tier architecture. The application demonstrates the fundamental concepts of separating frontend, backend, and database components in a web application.
...
This project was developed with guidance from the following YouTube tutorial. I implemented the project myself while following the concepts and deployment process demonstrated in the video.

- YouTube Tutorial: https://www.youtube.com/watch?v=yeyr6OBMfcE
